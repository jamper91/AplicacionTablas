...
<div class="wrap">
	...
	<div class="main">
			...
			<form action="" method="get">
				...
				<input type="text" id="datepicker" name="fecha1" value="<?=$fecha1?>"  placeholder="Fecha Inicio">
                
				Hasta:
				<input type="text"  id="datepicker1" name="fecha2" value="<?=$fecha2?>" placeholder="Fecha Fin">
			</br>
				...
				$(function() {
					...
					if($_GET){
						...
						if($select && $buscar){
							...
							if($select=="usuario"){ $parametro=" AND c.nombre LIKE '%".$buscar."%'"; }
							if($select=="todo"){
