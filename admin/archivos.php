...
<div class="wrap">
	<div class="main">
		...
		<div class="contact-form-">
			<form action="" method="get">
				...
				<label>Buscar por contenido: </label><input type="text" id="valor" name="valor" class="" value="<?=$val?>" size="30" placeholder="palabra a Buscar">
				<select name="select">
    ...
    <div class="tabla2" >
            ...
            <?php
				...
				$sql="select a.id as id,a.nombre as nombre, c.nombre as categoria from archivos a, categoria c where  a.idCategoria=c.id AND  a.idUsuario=".$_SESSION['idUsuario']." ".$parametro ;
				$result=consultar($sql);
				$html='';
				while($row=mysql_fetch_assoc($result))
				{
